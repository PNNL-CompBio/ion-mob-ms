...
def execute_workflow(json_file):
    ...
    if data[0]["Experiment"] == 0:
        ...
        if data[1]["ac_1"] == True:
            ...
            AC_step_mac.run_container("single","standard",data[3]["Calibrant Data"],False, data[3]["Feature Data"], False, data[3]["Raw File Metadata"])
        if data[1]["ac_2"] == True:
    ...
    if data[0]["Experiment"] == 2:
        ...
        if data[1]["ac_1"] == True:
            ...
            data[3]["FrameMetadata"] = (data[3]["FrameMetadata"]).replace(" ", "\ ")
            data[3]["Feature Data"] = (data[3]["Feature Data"]).replace(" ", "\ ")
            AC_step_mac.run_container("step","enhanced",False, data[3]["FrameMetadata"], data[3]["Feature Data"], data[3]["Target List"],False)
