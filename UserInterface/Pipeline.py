...
#Instead, "mac" and "pc" arguments are passed into the run_container functions.
    ...
    if data[0]["Experiment"] == 0:
        ...
        if data[1]["ac_1"] == True:
            ...
            AC_step.run_container("single","standard",data[3]["Calibrant Data"],False, data[3]["Feature Data"], False, data[3]["Raw File Metadata"])
        if data[1]["ac_2"] == True:
            print("AutoCCS finds features through the enhanced method.")
            AC_step.run_container("single","enhanced",data[3]["Calibrant Data"],data[3]["FrameMetadata"], data[3]["Feature Data"], False, data[3]["Raw File Metadata"])
    ...
    if data[0]["Experiment"] == 2:
        ...
        if data[1]["ac_1"] == True:
            print("AutoCCS finds features through the enhanced method.")
            AC_step.run_container("step","enhanced",False, data[3]["FrameMetadata"], data[3]["Feature Data"], data[3]["Target List"],False)