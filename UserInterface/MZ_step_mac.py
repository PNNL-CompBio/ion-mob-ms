...
batch_file = "/Users/jaco059/OneDrive - PNNL/Desktop/IonMobility_Desktop_App_Front_End/ion-mob-ms/test-data/SteppedField/MZmine_FeatureFinder-batch.xml"
...
def run_container():
    ...
    image = "jjacobson95/mzmine"
    local_mem = "/Users/jaco059/OneDrive - PNNL/Desktop/IonMobility_Desktop_App_Front_End/docker_test_area/MZ_solo_area/tmp"
    # print("the locaal mem : ", local_mem)
    
    xml_file= "/Users/jaco059/OneDrive - PNNL/Desktop/IonMobility_Desktop_App_Front_End/Backend_Pipeline/autoCCS_step_config.xml"
    ...
    print("A\n")
    copy_a_file(client, xml_file, 'AC_container:/tmp/xml_file')
    print("B\n")
    ...
    # print("E\n")
    # AC_Container = client.containers.get('MZ_Container')
    # time.sleep(5)
    # print("F\n")
