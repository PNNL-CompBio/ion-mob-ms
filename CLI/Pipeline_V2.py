...
def execute_workflow(json_file):
    ...
    if data[0]["ExpType"] == "Single" or data[0]["ExpType"] == "Any":
        ...
        if "PW" in data[0]["ToolType"]:
            ...
            PW_results = PW_step.run_container(data[1]["PreProcessed Data Folder"],data[1]["mzML Data Folder"],data[0]["ExpType"])
        ...
        if "MZ" in data[0]["ToolType"]:
            ...
            print(data[1])
            MZ_results = MZ_step.run_container(data[1]["mzML Data Folder"],data[1]["Feature Data Folder"])
        if "AC" in data[0]["ToolType"] and "IMS Metadata Folder" not in data[1] and "Target List File" not in data[1]:
            ...
            AC_results= AC_step.run_container("single","standard",False, data[1]["Calibrant File"],False, data[1]["Feature Data Folder"], False, False, data[1]["PreProcessed Data Folder"],data[1]["AutoCCS Config File"],data[1]["AutoCCS Results"])
        
        if "AC" in data[0]["ToolType"] and "IMS Metadata Folder" not in data[1] and "Target List File" in data[1]:
            AC_results= AC_step.run_container("single","standard",True, data[1]["Calibrant File"],False, data[1]["Feature Data Folder"], data[1]["Target List File"], False, data[1]["PreProcessed Data Folder"],data[1]["AutoCCS Config File"],data[1]["AutoCCS Results"])
        ...
        if "AC" in data[0]["ToolType"] and "IMS Metadata Folder" in data[1] and "Target List File" not in data[1]:
            ...
            AC_results= AC_step.run_container("single","enhanced",False, data[1]["Calibrant File"], data[1]["IMS Metadata Folder"], data[1]["Feature Data Folder"], False, False,data[1]["PreProcessed Data Folder"],data[1]["AutoCCS Config File"],data[1]["AutoCCS Results"])
    
        if "AC" in data[0]["ToolType"] and "IMS Metadata Folder" in data[1] and "Target List File" in data[1]:
            print("AutoCCS finds features through the enhanced method. \nTarget list specified, annotations will proceed after AutoCCS.")
            AC_results= AC_step.run_container("single","enhanced",True, data[1]["Calibrant File"], data[1]["IMS Metadata Folder"], data[1]["Feature Data Folder"],data[1]["Target List File"], False,data[1]["PreProcessed Data Folder"],data[1]["AutoCCS Config File"],data[1]["AutoCCS Results"])
    ...
    if data[0]["ExpType"] == "SLIM":
        ...
        if "AC" in data[0]["ToolType"] and "Target List File" not in data[1]:
            print("AutoCCS finds features through the standard method.\nNo Target list specified, annotations will be skipped. ")
            AC_results= AC_step.run_container("slim","standard",False, data[1]["Calibrant File"],False, data[1]["Feature Data Folder"], False, data[1]["Metadata File"],False,data[1]["AutoCCS Config File"],data[1]["AutoCCS Results"])
        if "AC" in data[0]["ToolType"] and "Target List File" in data[1]:
            print("AutoCCS finds features through the standard method.\nTarget list specified, annotations will proceed after AutoCCS.")
            AC_results= AC_step.run_container("slim","standard",True, data[1]["Calibrant File"],False, data[1]["Feature Data Folder"], data[1]["Target List File"], data[1]["Metadata File"],False,data[1]["AutoCCS Config File"],data[1]["AutoCCS Results"])
    ...
    if data[0]["ExpType"] == "Stepped":
        ...
        if "AC" in data[0]["ToolType"]:
            print("AutoCCS finds features through the enhanced method.")
            AC_results= AC_step.run_container("step","enhanced",True,False, data[1]["IMS Metadata Folder"], data[1]["Feature Data Folder"], data[1]["Target List File"], False,False,data[1]["AutoCCS Config File"],data[1]["AutoCCS Results"])
